...
$db_config_path = '../classes/config.php';
...
if($_POST) {
	...
	if($core->validate_post($_POST) == true)
	{
		...
		if(!isset($message)) {
	      ...
	      $message= $core->show_message('success',"SIAVS Setup completed successfully. Click <a href='".$redir."'>here</a>  to start");
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>SIAVS Installation | TopTech Solutions - Student Identity And Attendance Verification System</title>
    ...
    <center><h1>SIAVS Install</h1></center>
    <?php if(is_writable($db_config_path)){?>
	  ...
	  <?php } else { ?>
      <p class="error">Please make the classes/config.php file writable. <strong>Example</strong>:<br /><br /><code>chmod 777 classes/config.php</code></p>
	  <?php } ?>
